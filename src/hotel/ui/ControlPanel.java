...
public class ControlPanel extends javax.swing.JFrame {
    ...
    private final DatabaseOperation db;
    ...
    private void bookingObjectCreation() {
        ...
        if (existingCustomer) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Error getting customer ID", ex);
                JOptionPane.showMessageDialog(null, "Error getting customer ID: " + ex.getMessage());
            }
            db.flushAll();
        }
    }
    ...
    private void userComboFill(ResultSet rs) {
        customerList.clear();
        try {
            while (rs.next()) {
                customerList.add(rs.getString("name") + ", " + rs.getString("address") + "," + rs.getString("user_id"));
            }
        } catch (SQLException ex) {
            LOGGER.log(Level.SEVERE, "Error processing user results", ex);
            JOptionPane.showMessageDialog(null, "Error processing user results: " + ex.getMessage());
        }
    }
    ...
    private void customerIdPropertyChange(java.beans.PropertyChangeEvent evt) {
        if (evt.getNewValue() != null) {
            try {
                int customerId = Integer.parseInt(evt.getNewValue().toString());
                ResultSet userDB = db.searchAnUser(customerId);
                // Process userDB here
            } catch (SQLException ex) {
                LOGGER.log(Level.SEVERE, "Error searching user", ex);
                JOptionPane.showMessageDialog(null, "Error searching user: " + ex.getMessage());
            } catch (NumberFormatException ex) {
                LOGGER.log(Level.WARNING, "Invalid customer ID format", ex);
                JOptionPane.showMessageDialog(null, "Invalid customer ID format");
            }
        }
    }

    private void customerNamePropertyChange(java.beans.PropertyChangeEvent evt) {
        if (evt.getNewValue() != null) {
            ...
            if (!value.equals("")) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Error searching users: " + ex.getMessage());
                }
            }
        }
    }
